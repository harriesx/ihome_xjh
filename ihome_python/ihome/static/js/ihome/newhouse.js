...
$(document).ready(function(){
    ...
    $.get("/api/v1.0/areas", function (resp) {
        if (resp.errno == "0") {
            ...
            // 使用js模板
            var html = template("areas-tmpl", {areas: areas})//整成一个模板，html里面就可以用｛｛｝｝遍历了
            $("#area-id").html(html);
    ...
    $("#form-house-image").submit(function (e) {//上传的按钮
        e.preventDefault();
        $(this).ajaxSubmit({
            ...
            success: function (resp) {
                if (resp.errno == "4101") {
                    ...
                    $(".house-image-cons").append('<img src="' + resp.data.image_url +'">');//在原处显示图片
                } else {
                    alert(resp.errmsg);
                }
            }
